$(() => {
  ...
  /**the 2 listeners below will build out the functionality of the form 
   * and handle submissions as well as provide a way to cancel out of 
   * submitting a reservation gracefully */ 
